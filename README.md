...
CREATE TABLE `proveedor` (
  ...
  `Nombre_proveedor` varchar(70) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `fk_ciudad` FOREIGN KEY (`id_ciudad`) REFERENCES `ciudades` (`id_ciudad`),
  ...
  ADD CONSTRAINT `fk_parroquia` FOREIGN KEY (`id_parroquia`) REFERENCES `parroquias` (`id_parroquia`),
  ADD CONSTRAINT `fk_perfil` FOREIGN KEY (`Id_perfil`) REFERENCES `perfiles_usuario` (`Id_perfil`);
COMMIT;
